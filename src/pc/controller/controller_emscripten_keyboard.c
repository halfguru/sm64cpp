...
static EM_BOOL controller_emscripten_keyboard_handler(int event_type,
...
static EM_BOOL controller_emscripten_keyboard_blur_handler(
    UNUSED int event_type, UNUSED const EmscriptenFocusEvent *focus_event, UNUSED void *user_data)
{
